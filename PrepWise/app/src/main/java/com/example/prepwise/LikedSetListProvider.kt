    ...
    val setList = arrayListOf(
        Set(
            ...
            questions = arrayListOf(
                ...
                Question("What is Fragment?", "Part of a UI", false)
            ),
            username = "dev_junior",
            isLiked = true
        ),
        Set(
            ...
            questions = arrayListOf(
                Question("What is DataFrame?", "A table-like structure in pandas", false),
        ...
        Set(
            ...
            questions = arrayListOf(
                Question("What is a closure?", "A function with access to outer variables", false),
                Question("What is DOM?", "Document Object Model", false)
            ),
            username = "web_master",
            isLiked = true
        ),
        Set(
            ...
            questions = arrayListOf(
                ...
                Question("What is a confusion matrix?", "A table used to describe the performance of a classification model.", false)
            ),
            username = "ml_expert",
            isLiked = true
        ),
        ...
        Set(
            ...
            questions = arrayListOf(
                ...
                Question("What is UIKit?", "A framework for building user interfaces in iOS.", true)
            ),
            username = "ios_dev",
            isLiked = true
        )
